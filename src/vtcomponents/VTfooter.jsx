      ...
      <div className="max-w-screen-xl px-4 mx-auto">
        <div className="grid grid-cols-1 gap-8 xl:gap-12 md:grid-cols-3">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-semibold text-[#FD4101] mb-4">Venture Talks</h2>
          ...
          <div className="text-center md:text-left">
            ...
            <p className="flex items-center justify-center mb-2 md:justify-start">
              ...
              <a href="mailto:venturetalkscssc@gmail.com" className="font-normal ">venturetalkscssc@gmail.com</a>
            </p>
            <p className="flex items-center justify-center mb-2 md:justify-start">
              <span className="mr-2">📞</span> 
              <a href="tel:+94123456789" className="font-normal ">+94 123 456 789</a>
            </p>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <ul className="space-y-2 font-normal">
              ...
              <li>
                <a href="/join" className="hover:text-[#6366f1]">Join</a>
              </li>
              <li>
                <a href="/about" className="hover:text-[#6366f1]">About</a>
              </li>
              <li>
                <a href="/contact" className="hover:text-[#6366f1]">Contact</a>
              </li>
              <li>
                <a href="/episodes" className="hover:text-[#6366f1]">Episodes</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 mt-12 text-center border-t border-gray-700">
          <p className="font-normal text-md">
            &copy; {new Date().getFullYear()} Venture Talks CSSC. All rights reserved.
          </p>
          <p className="text-base font-normal ">
            created by <a href="https://web.facebook.com/akilashehan.induwara/"><span>Shehan Induwara</span></a>
          </p>
        </div>
      </div>
    </footer>
