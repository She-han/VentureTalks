...
const TabContent = ({ activeTab }) => {
          ...
          <div className="mt-12">
            ...
            <div className="text-base font-normal text-gray-900 dark:text-gray-200 justify-normal ">
              <ul className="pl-5 mb-4 space-y-4 list-disc ">
                ...
                <li>
                Hearing experts' success stories and challenges
              inspires determination and motivates us to
              confidently pursue our goals.
                </li>
                <li>
                Staying informed about IT trends and technologies
                will prepare us for future career opportunities.
                </li>
                <li>
                Podcasts illustrate the practical application of
              theoretical concepts, making our learning more
              meaningful.
                </li>
                <li>
                We can establish strong connections with industry
                experts, fostering valuable relationships.
                </li>
              </ul>
            </div>
          </div>
      ...
      return (
        <div className="p-6 bg-gray-200 dark:bg-gray-800 md:p-10 rounded-xl">
          ...
          <div className="mt-0">
            ...
            <div className="text-base font-normal text-gray-900 dark:text-gray-200 justify-normal ">
            <p className="mb-4">
        The <span className="font-semibold text-gray-900 dark:text-gray-200">Computer Science Students’ Community (CSSC) </span> 
         of the University of Ruhuna is Sri Lanka's southernmost hub of tech enthusiasts, 
        where innovation, collaboration, and technology converge. Established to inspire 
        and empower students, CSSC is a vibrant platform that nurtures creativity, 
        technical expertise, and a passion for problem-solving.
      </p>
      <p className="mb-8">
        Our community is known for organizing flagship events that challenge and engage 
        aspiring tech leaders, including:
      </p>
      <ul className="mb-8 list-disc list-inside">
        <li>
          <span className="font-semibold text-gray-900 dark:text-gray-200">Rush Coder </span>: An exhilarating intra-university hackathon 
          that sparks innovation and showcases students' coding prowess.
        </li>
        <li>
          <span className="font-semibold text-gray-900 dark:text-gray-200">Insurgex 1.0 </span>: A cutting-edge hackathon designed to 
          push boundaries and expand technological horizons.
        </li>
      </ul>
      <p className="mb-4">
        In partnership with global networks like the <span className="font-semibold text-gray-900 dark:text-gray-200">Google Developers Group</span>, 
        CSSC delivers world-class workshops that equip members with the latest tools, trends, and 
        techniques in the tech landscape.
      </p>
      <p className="mb-4">
        Beyond technology, CSSC embraces cultural expression through unique events like 
        <span className="font-semibold text-gray-900 dark:text-gray-200"> CS Padura</span>, which seamlessly blends creativity and the arts, 
        celebrating the multifaceted talents of our members.
      </p>
      <p>
        At CSSC, we are more than a community—we are a movement driving the future of technology 
        and fostering a spirit of camaraderie among computer science students. Join us as we innovate, 
  ...
  <div class="grid grid-rows-2 gap-4">
    ...
    case "profiles":
      return (
        <div className="p-6 bg-gray-200 dark:bg-gray-800 md:p-10 rounded-xl">Welcome to profiles!</div>
